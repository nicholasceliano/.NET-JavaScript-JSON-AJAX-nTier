<%@ Page Title="" Language="C#" MasterPageFile="~/GHGPortal.Master" AutoEventWireup="true" CodeBehind="GHGadmAppNewFacilities.aspx.cs" Inherits="Hess.Corporate.GHGPortal.Web.UI.GHGadmAppNewFacilities" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajax" %>
<%@ Register Src="~/Controls/ApproveNewFacilitiesView.ascx" TagName="ApproveNewFacilities" TagPrefix="af" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="GHGScriptManager" runat="server" AsyncPostBackTimeout="0" />
    <asp:Label ID="lblPageTitle" runat="server" Text="Approve New Facilities" CssClass="SSIS_Title" />
    ...
    <asp:UpdatePanel ID="updatePanelGrid" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <af:ApproveNewFacilities ID="ctrlApproveNewFacilities" runat="server" EnableViewState="false" />
        </ContentTemplate>
        <Triggers>
